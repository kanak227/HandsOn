  ...
  const toggleVideo = () => {
    ...
    return (
      <div 
        ...
        style={{
          minHeight: "100vh",
          background: "linear-gradient(135deg, #18181b 0%, #05505a 100%)", // Match homepage gradient
      ...
      <nav className="asl-navbar">
        ...
        <div className="main-container" style={{ color: "#fff" }}>
          {!isRegistered ? (
            <div className="register-box">
              ...
              <button 
                ...
                style={{
                  background: "linear-gradient(135deg, #05505a 0%, #18181b 100%)",
                  color: "#fff",
                  border: "none",
                  borderRadius: "6px",
                  padding: "10px 24px",
                ...
                onMouseOver={e => e.currentTarget.style.background = "linear-gradient(135deg, #0a7c8c 0%, #23232b 100%)"}
                onMouseOut={e => e.currentTarget.style.background = "linear-gradient(135deg, #05505a 0%, #18181b 100%)"}
              >
                Register
              </button>
            </div>
            ...
            <div className="video-call-wrapper">
              ...
              {/* Incoming Call Alert */}
              {incomingCall && (
                <div className="incoming-call-alert" style={{ color: "#fff" }}>
              ...
              <div className="maincont" style={{ display: "flex", gap: "32px", alignItems: "stretch" }}>
                <div className="streams-container" style={{ flex: 2, display: "flex", gap: "16px" }}>
                  <div className="video-stream local" style={{ color: "#fff", flex: 1 }}>
                    <video
                      ref={localVideoRef}
                      autoPlay
                      playsInline
                  ...
                  <div className="video-stream remote" style={{ color: "#fff", flex: 1 }}>
                    <video
                      ref={remoteVideoRef}
                      autoPlay
                      playsInline
                ...
                <div
                  className="chat-transcription-container"
                  style={{
                    color: "#fff",
                    flex: 1,
                    display: "flex",
                ...
                >
                  ...
                  >
                    ...
                    <div className="transcription-content" style={{ flex: 1, minHeight: 0, overflowY: "auto" }}>
